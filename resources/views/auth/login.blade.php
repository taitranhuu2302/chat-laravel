            ...
            <div class="col-span-8 h-full bg-white content flex flex-col">
                <div class="mx-auto flex items-center justify-center flex-col h-full w-full">
                    ...
                    <div class="wrapper-button-social mb-6">
                        <a href="{{ url('/auth/google') }}" type="button" class="w-full text-white bg-[#ea4335] hover:bg-[#ea4335]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex justify-center items-center dark:focus:ring-[#ea4335]/55 mr-2 mb-2">
