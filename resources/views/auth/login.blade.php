...
<div id="wrapper">
    <div class="grid grid-cols-12 h-full">
        ...
        <div class="col-span-8 h-full bg-white content flex flex-col md:col-span-12">
            <div class="mx-auto flex items-center justify-center flex-col h-full w-full">
                    ...
                    <div class="flex items-start mb-6">
                        <div class="flex items-center h-5">
                            <input id="remember" name="remember" aria-describedby="remember" type="checkbox"
                                   class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-green-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800">
                        </div>
                ...
                <div>
                    <p class="text-gray-500">Don't have account ? <a href="/auth/register"
                                                                     class="font-semibold text-[#4eac6d]">Register</a>
                    </p>
                </div>
            </div>
