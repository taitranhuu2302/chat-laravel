        ...
        <ul class="nav__top flex flex-col items-center gap-8" data-tabs-toggle="#sidebar">
            ...
            <li>
                <button id="button-friend" data-tabs-target="#chat" type="button" role="tab" aria-controls="chat"
                        aria-selected="false"
                        data-tooltip-target="tooltip-chat" class="nav__top--button nav__top--active">
            ...
            <li>
                <button id="button-friend-request" data-tabs-target="#friend-request" type="button" role="tab" aria-controls="friend-request"
                        aria-selected="false" data-tooltip-target="tooltip-friend-pending" class="nav__top--button">
            ...
            <li>
                ...
                <div id="dropdown_user"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown_user">
                        ...
                        <li>
                            <a href="#"
                               class="block text-lg font-semibold py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                        </li>
                        <li>
