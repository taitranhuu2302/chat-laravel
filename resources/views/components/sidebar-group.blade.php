<div class="h-full flex flex-col">
    ...
    <div class="group__search flex-shrink p-8">
    ...
    <ul class="group__rooms flex flex-col border-t overflow-y-auto flex-grow">
        <li class="rooms__item border-b py-3 w-full px-8 flex items-center">
            ...
            <button data-dropdown-toggle="dropdown-group" data-dropdown-placement="right">
