        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                <div class="flex items-center gap-3">
                    <i class="text-xl font-semibold text-gray-900 far fa-users"></i>
            ...
            <div class="p-6 space-y-6">
                <div>
                    <label for="group_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tên
                        nhóm</label>
                ...
                <div class="flex items-center gap-2">
                    <div id="list-avatar-user-to-room" class="flex -space-x-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="search-add-friend"
                            class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Tìm kiếm..." required>
                        <button id="btn-add-friend-to-room" type="button"
                ...
                <div>
                    <label for="message_group"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Lời
                        mời</label>
                    <textarea id="message_group" rows="4"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Hãy nói gì đó..."></textarea>
                </div>
            </div>
            <!-- Modal footer -->
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                ...
                <button data-modal-toggle="create-group-modal" type="button"
