...
$(function () {
  ...
  $('#form-add-friend').submit(function (e) {
    ...
    axios.post('/user/add-friend-request', {
      ...
      email.val('');
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Success', 'Friend request has been sent', 'success');
        ...
        if (result.isConfirmed) {
          axios.post('/user/accept-friend-request', {
            ...
            if (response.data.status === 200) {
              parent.remove();
              sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Accepted friend request!', '', 'success');
            }
          })["catch"](function (error) {
            console.log(error);
          });
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        if (result.isConfirmed) {
          axios.post('/user/block-friend-request', {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Cancellation of friend request successfully!', '', 'success');
          })["catch"](function (error) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
        ...
        if (result.isConfirmed) {
          axios.post('/user/block-friend', {
            ...
            if (response.data.status === 200) {
              parent.remove();
              sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Unfriended successfully!', '', 'success');
            }
          })["catch"](function (error) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Error! An error occurred. Please try again later!', '', 'error');
          });
