...
$(function () {
  ...
  $('#task-form').submit(function (e) {
    ...
    var content = $('#content-task');
    var dueDate = $('#due-date-task');
    var request = {
      title: title.val(),
      content: content.val(),
    ...
    axios.post('/task', request).then(function (response) {
      var taskResponse = response.data.data;
      ...
      var wrapperListAvatar = $('#list-avatar-user-for-task');
